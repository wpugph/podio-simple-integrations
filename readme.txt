...
Installing "PD Simple Integrations" can be done either by searching for "PD Simple Integrations" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
